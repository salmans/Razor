...
ffi: 
        ...
        read SHARED_LIB_EXT;\
        ghc --make -fPIC -package hxt -odir binaries -hidir binaries ffi.hs -c
        ghc --make -no-hs-main -shared -static -fno-shared-implib -optl-Wl,-rpath,$$GHC_LIB_PATH binaries/FFI.o -o bin/haskell.$$SHARED_LIB_EXT
