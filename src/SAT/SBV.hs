...
{- Razor
   Module      : SAT.SBV
   Description : The module provides an interface to SBV 
   (http://hackage.haskell.org/package/sbv) for SMT translation and solving.
...
{- SMTObservation represents an 'Observation' in SMT solving:
   ...
   [@SMTEq@]   denotes equality between two elements.
-} 
