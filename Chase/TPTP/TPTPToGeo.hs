...
module Chase.TPTP.TPTPToGeo (inputsToGeo) where
-- 
...
import qualified Chase.Tools.GeoUnification as Unif (lift)
import qualified Chase.Utils.GeoUtilities as GeoUtilities
import qualified Chase.Tools.FolToGeo as F2G
