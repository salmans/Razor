...
-- 
module Chase.Tools.Herbrand 
-- ( herbfuns , groundtuples , gilmore , dpRefineLoop , davisputnam , davisputnam' ) 
where
-- 
import Prelude 
...
import Formulas(Formula(..), Clauses, Vars, Sym)
...
-- 
herbfuns :: Formula Fol -> ([Func], [Func])
herbfuns fm = 
...
-- 
groundterms :: [Term] -> [Func] -> Int -> [Term]
...
-- groundtuples 
-- 
groundtuples :: [Term] -> [Func] -> Int -> Int -> [[Term]]
...
-- 
herbloop :: (a -> (Formula Fol -> Formula Fol) -> [b] -> [b])
         -> ([b] -> Bool) 
         -> a -> [Term] -> [Func] -> Vars -> Int
         -> [b] -> [[Term]] -> [[Term]] -> IO [[Term]]
...
-- 
gilmoreLoop :: Clauses Fol -> [Term] -> [Func] -> Vars -> Int
            -> Clauses Fol -> [[Term]] -> [[Term]] -> IO [[Term]] 
gilmoreLoop =
...
-- rather than DNF:
-- 
dpMfn :: Clauses Fol -> (Formula Fol -> Formula Fol) -> Clauses Fol -> Clauses Fol
dpMfn cjs0 ifn cjs = ListSet.union (map (map ifn) cjs0) cjs
-- 
dpLoop :: Clauses Fol -> [Term] -> [Func] -> Vars 
          -> Int -> Clauses Fol -> [[Term]] -> [[Term]] -> IO [[Term]] 
...
-- 
dpRefine :: Clauses Fol -> Vars -> [[Term]] -> [[Term]] -> [[Term]] 
...
-- 
dpRefineLoop :: Clauses Fol -> [Term] -> [Func] -> Vars 
                -> Int -> Clauses Fol -> [[Term]] -> [[Term]] -> IO [[Term]]
