{-
  Author: Salman Saghafi
  Updated: 2014-04-20 by vpatara
  Runs chase on the input theory and returns the models
  for the theory (if any exist).
-}
...
import FCAtlas -- porting FindCore and Atlas
-- ============================
-- Main
-- ============================
